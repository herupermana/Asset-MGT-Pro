...
export const MOCK_TECHNICIANS: Technician[] = [
  { id: 'TECH-01', name: 'Budi Santoso', specialty: 'Electrical', activeTasks: 2, password: 'password123', rank: 'Senior Specialist', averageRating: 4.8 },
  { id: 'TECH-02', name: 'Siti Aminah', specialty: 'HVAC', activeTasks: 1, password: 'password123', rank: 'Expert Advisor', averageRating: 4.9 },
  { id: 'TECH-03', name: 'Andi Wijaya', specialty: 'IT Network', activeTasks: 0, password: 'password123', rank: 'Junior Associate', averageRating: 4.5 }
];
